...
//			targetLoc = new Coord(12, 18);
		...
		while (true) {
			...
			this.doScan();
			live.addScanMap(scanMap, currentLoc, RoverToolType.CHEMICAL_SENSOR, RoverToolType.RANGE_BOOTER); // this																										
			live.debugPrintRevealCounts(currentLoc, RoverToolType.CHEMICAL_SENSOR, RoverToolType.RANGE_BOOTER);
